from data_analysis import file_operate,preprocess
import pandas as pd
import numpy as np
fop=file_operate.FileOperator()
prcesspor=preprocess.PreProcessor(fop)
# fop.read_file('file1',r'C:\python\projects\QuickPanda\data\sample',file_type='csv',sep=',',show_detail=False)
# fop.read_file('file2',r'C:\python\projects\QuickPanda\data\SAR.csv',sep=',',show_detail=False)
fop.read_file('file3',r'C:\python\projects\QuickPanda\data\detail.csv',sep=',',show_detail=False)
# fop.read_file('file4',r'C:\python\projects\QuickPanda\data\附件1：data_100.csv',sep=',',show_detail=False)
# fop.read_file('file5',r'C:\python\projects\QuickPanda\data\附件3：飞行参数测量数据.xlsx',sep=',',show_detail=False)
...
# prcesspor.fillna()
# prcesspor.dropna()
prcesspor.drop_outliers(draw=True)
# prcesspor.norm()
# prcesspor.standard()
# prcesspor.show_files_cols_desc()
fop.get_details()
